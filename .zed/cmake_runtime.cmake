...
elseif(STURDY_RUNTIME_PROFILE STREQUAL "release")
    set(_configure_preset "ninja-release")
    set(_build_preset "runtime-release")
    set(_runtime_path "build/ninja/release/bin/Runtime")
    set(_windows_runtime_path "build/ninja/release/bin/Runtime.exe")
