...
namespace SFT::WindowManager::Detail {
    ...
    /// Performs the window log operation for `Detail` using the supplied arguments.
    ///
    ...
    /// Performs the window trace operation for `Detail` using the supplied arguments.
    ///
    /// @param format Format used for the resource, render target, or conversion.
    /// @param args `args` value used by the operation.
    ///
    ...
    /// Performs the window debug operation for `Detail` using the supplied arguments.
    ///
    /// @param format Format used for the resource, render target, or conversion.
    /// @param args `args` value used by the operation.
    ///
    ...
    /// Performs the window info operation for `Detail` using the supplied arguments.
    ///
    /// @param format Format used for the resource, render target, or conversion.
    /// @param args `args` value used by the operation.
    ///
    ...
    /// Performs the window warn operation for `Detail` using the supplied arguments.
    ///
    /// @param format Format used for the resource, render target, or conversion.
    /// @param args `args` value used by the operation.
    ///
    ...
    /// Performs the window error operation for `Detail` using the supplied arguments.
    ///
    /// @param format Format used for the resource, render target, or conversion.
    /// @param args `args` value used by the operation.
    ///
