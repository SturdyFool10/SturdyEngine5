...
namespace {
    ...
    bool normalization_is_provider_independent() {
        using SFT::WindowManager::GLFW::Detail::normalize_mouse_button;
...
int main() {
    ...
    passed &= manager_keeps_window_access_on_one_owner(
        SFT::WindowManager::WindowManagerPolicy{
            .event_pump_mode = SFT::WindowManager::WindowEventPumpMode::CallerThread,
            .platform_allows_threads = true,
        },
        false);
    passed &= manager_keeps_window_access_on_one_owner(
        SFT::WindowManager::WindowManagerPolicy{
            .event_pump_mode = SFT::WindowManager::WindowEventPumpMode::DedicatedEventThread,
            .platform_allows_threads = true,
        },
        SFT::WindowManager::compile_time_window_thread_allowed);
    return passed ? 0 : 1;
}
