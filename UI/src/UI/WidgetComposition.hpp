...
namespace SFT::UI {
    ...
    inline void apply_element_visual_patch(ElementDecl &decl, const ElementVisualPatch &patch) noexcept {
    ...
    inline void apply_part_visual(ElementDecl &decl, const PartVisualStyle &style, const PartVisualState &state) noexcept {
    ...
    inline void clear_element_visual(ElementDecl &decl) noexcept {
