...
namespace SFT::Engine {
    ...
    class FrameTime {
      public:
        ...
        [[nodiscard]] f64 delta_seconds() const noexcept { return delta_seconds_; }
        [[nodiscard]] f64 unscaled_delta_seconds() const noexcept { return unscaled_delta_seconds_; }
        [[nodiscard]] u64 tick_index() const noexcept { return tick_index_; }
