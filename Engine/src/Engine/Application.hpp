...
namespace SFT::Engine {
    ...
    class Application {
      ...
      private:
        ...
        /// for the same WindowEffectKind), if `id` is currently a managed window. This is the only
        /// place that record is written — see its own doc comment (ManagedWindow) for why it exists.
