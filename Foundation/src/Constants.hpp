...
namespace SFT::Foundation {
    ...
    namespace Detail {
        ...
        /// Returns the current or globally available constant value.
        ///
...
namespace SFT::Foundation {
    ...
    /// Returns the current or globally available zero value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    ...
    /// Returns the current or globally available one value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available tau value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available two pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available three pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available four pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available half pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available third pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available quarter pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available inv pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available inv tau value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available two over pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available four over pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available pi squared value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available pi cubed value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Computes the sqrt pi math operation over the supplied values or element range.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available inv sqrt pi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Computes the sqrt tau math operation over the supplied values or element range.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Computes the sqrt half pi math operation over the supplied values or element range.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available deg to rad value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available rad to deg value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available grad to rad value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available rad to grad value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available e value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available inv e value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available log2 e value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available log10 e value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available phi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available inv phi value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available phi squared value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available silver ratio value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available plastic value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available euler mascheroni value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available catalan value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available apery value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available feigenbaum delta value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available feigenbaum alpha value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available khinchin value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available glaisher kinkelin value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available conway value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
    ...
    /// Returns the current or globally available omega value.
    ///
    /// @return Returns the value produced by the operation.
    /// @note This function does not throw exceptions.
    template <Detail::ConstantScalar T = f64>
...
namespace SFT::Foundation::Detail {
    ...
    /// Performs the qd abs operation using the supplied arguments.
    ///
    ...
    /// Performs the qd close operation using the supplied arguments.
    ///
    ...
    /// Returns the current or globally available constants precision smoke test value.
    ///
    /// @return Returns the boolean result of the operation.
    /// @note This function does not throw exceptions.
