...
// standard library reaches for traits: numeric_limits (generic numeric code), hash
// (unordered containers), formatter (format / logging), and stream insertion.
//
// Reach/limits note: is_arithmetic / is_integral / is_floating_point CANNOT be
