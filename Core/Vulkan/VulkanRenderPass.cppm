...
class VulkanRenderPass {
  public:
    ...
    VulkanRenderPass& operator=(VulkanRenderPass&& o) noexcept {
        if (this != &o) { destroy(); device_ = o.device_; render_pass_ = o.render_pass_;
            o.device_ = VK_NULL_HANDLE; o.render_pass_ = VK_NULL_HANDLE; }
        return *this;
    }
  ...
  public:
    ...
    VulkanFramebuffer& operator=(VulkanFramebuffer&& o) noexcept {
        if (this != &o) { destroy();
            device_ = o.device_; framebuffer_ = o.framebuffer_;
            width_  = o.width_;  height_      = o.height_; layers_ = o.layers_;
            o.device_ = VK_NULL_HANDLE; o.framebuffer_ = VK_NULL_HANDLE; }
        return *this;
    }
