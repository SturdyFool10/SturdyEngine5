...
class VulkanSurface {
  public:
    ...
    VulkanSurface(VkSurfaceKHR vk_surface, RenderSurfaceDescriptor descriptor,
                  Window *window, Extent2D extent,
                  u32 frames_in_flight, u32 generation) noexcept
