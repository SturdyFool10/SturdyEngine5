...
class RenderingInfo {
  public:
    ...
    RenderingInfo& add_color(ColorAttachment att) {
        color_attachments_vk_.push_back(att.to_vk()); return *this;
    }
