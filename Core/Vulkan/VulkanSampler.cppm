...
class VulkanSampler {
  public:
    ...
    VulkanSampler& operator=(VulkanSampler&& o) noexcept {
        if (this != &o) { destroy(); device_ = o.device_; sampler_ = o.sampler_;
            o.device_ = VK_NULL_HANDLE; o.sampler_ = VK_NULL_HANDLE; }
        return *this;
    }

    [[nodiscard]] static RendererExpected<VulkanSampler> create(
        VkDevice device, const VkSamplerCreateInfo& info
    ) noexcept {
