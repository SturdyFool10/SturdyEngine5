...
class VulkanPipeline {
  public:
    ...
    VulkanPipeline& operator=(VulkanPipeline&& o) noexcept {
        if (this != &o) { destroy();
            device_ = o.device_; pipeline_ = o.pipeline_; bind_point_ = o.bind_point_;
            o.device_ = VK_NULL_HANDLE; o.pipeline_ = VK_NULL_HANDLE; }
        return *this;
    }
...
class VulkanPipelineCache {
  public:
    ...
    VulkanPipelineCache& operator=(VulkanPipelineCache&& o) noexcept {
        if (this != &o) { destroy(); device_ = o.device_; cache_ = o.cache_;
            o.device_ = VK_NULL_HANDLE; o.cache_ = VK_NULL_HANDLE; }
        return *this;
    }
    ...
    [[nodiscard]] static RendererExpected<VulkanPipelineCache> create(
        VkDevice device, span<const u8> initial_data = {}
    ) noexcept {
