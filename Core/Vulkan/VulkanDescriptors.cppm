...
class VulkanDescriptorSetLayout {
  public:
    ...
    VulkanDescriptorSetLayout& operator=(VulkanDescriptorSetLayout&& o) noexcept {
        if (this != &o) { destroy(); device_ = o.device_; layout_ = o.layout_;
            o.device_ = VK_NULL_HANDLE; o.layout_ = VK_NULL_HANDLE; }
        return *this;
    }
    ...
    [[nodiscard]] static RendererExpected<VulkanDescriptorSetLayout> create_from_bindings(
        VkDevice device, span<const VkDescriptorSetLayoutBinding> bindings,
...
class VulkanDescriptorPool {
  public:
    ...
    VulkanDescriptorPool& operator=(VulkanDescriptorPool&& o) noexcept {
        if (this != &o) { destroy(); device_ = o.device_; pool_ = o.pool_;
            o.device_ = VK_NULL_HANDLE; o.pool_ = VK_NULL_HANDLE; }
        return *this;
    }
    ...
    [[nodiscard]] static RendererExpected<VulkanDescriptorPool> create_from_sizes(
        VkDevice device, span<const VkDescriptorPoolSize> sizes, u32 max_sets,
