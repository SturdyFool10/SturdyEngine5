...
namespace SFT::Core::Slang {
    ...
    struct EmbeddedShaderSource {
        std::string_view relative_path; // e.g. "gbuffer_geometry.slang", relative to Shaders/
        std::string_view module_name;   // file stem -- matches discover_shaders()'s own module naming
