...
DecodedCodepoint decode_utf8(string_view text, usize offset) noexcept {
...
TextExpected<vector<PositionedGlyph>> shape_with_fallback(const FontStack &fonts, string_view utf8,
