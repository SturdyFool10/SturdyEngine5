...
namespace SFT::Renderer {
    ...
    [[nodiscard]] inline vector<GlyphPathPlacement2D> layout_text_on_spline_2d(const Spline2D &spline,
    ...
    [[nodiscard]] inline vector<glm::mat4> layout_text_on_spline_3d(const Spline3D &spline,
                                                                    span<const Text::PositionedGlyph> glyphs,
