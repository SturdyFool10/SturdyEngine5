...
namespace SFT::Ecs {
    ...
    /// Reports whether alive holds for this `Ecs`.
    ///
    /// @param entity Entity used or affected by the operation.
    ///
    /// @return Returns the value produced by the operation.
    ...
    /// Returns the current or globally available end scheduled execution value.
    ///
    /// @return Returns the current end scheduled execution value.
    /// @note This function does not throw exceptions.
    ...
    /// Reports whether alive unchecked holds for this `Ecs`.
    ///
    /// @param entity Entity used or affected by the operation.
    ///
    /// @return Returns the value produced by the operation.
...
namespace SFT::Ecs::Detail {
    ...
    /// Performs the begin schedule operation for `Detail` using the supplied arguments.
    ///
    ...
    /// Performs the end schedule operation for `Detail` using the supplied arguments.
    ///
    /// @param world World used or affected by the operation.
    ///
    /// @return Returns the value produced by the operation.
    ...
    /// Destroys or releases the `Detail` resource represented by the supplied parameters.
    ///
    /// @param world World used or affected by the operation.
    /// @param entity Entity used or affected by the operation.
    ///
...
namespace SFT::Ecs {
    ...
    /// Performs the world operation for `Ecs` using the supplied arguments.
    ///
